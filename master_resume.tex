...
\small{CS student with production AI/ML deployment experience: built real-time audio classification achieving 95\% accuracy with sub-50ms latency (\textbf{2nd place MHacks winner}), architected SSH management reducing server operations by 70\%, and led teams delivering ML systems with 80\%+ accuracy. Designed technical workshops for 500+ students maintaining 4.8/5 satisfaction across all sessions.}
...
\section{Projects}
    \resumeSubHeadingListStart
      \resumeProjectHeading
          ...
          \resumeItemListStart
            \resumeItem{Built real-time \textbf{audio classification} system for accessibility applications using \textbf{YAMNet model} on \textbf{MemryX MXA accelerators}, achieving \textbf{95\% accuracy} with $<$50ms \textbf{latency} across 521 event classes, enabling real-time hazard detection for hearing-impaired users. \textbf{Won 2nd place} in MemryX track at \textbf{MHacks} (24-hour hackathon, University of Michigan)}
          \resumeItemListEnd
      \resumeProjectHeading
          ...
          \resumeItemListEnd
      \resumeProjectHeading
          {\textbf{Cleanse - Adaptive Enemy AI Game} $|$ \emph{Unity, ML-Agents, C\#, Deep Reinforcement Learning}}{August 2024}
          \resumeItemListStart
            \resumeItem{Developed Unity game with adaptive enemy AI using \textbf{ML-Agents} and \textbf{Deep Reinforcement Learning} to learn player behavior patterns. Trained agents to dynamically adjust \textbf{Finite State Machine} strategies mid-game, creating increasingly challenging encounters as enemies adapted to individual playstyles, improving player engagement by 40\%}
          \resumeItemListEnd
    \resumeSubHeadingListEnd
